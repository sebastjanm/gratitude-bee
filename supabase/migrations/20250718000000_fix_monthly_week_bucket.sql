-- 20250718000000_fix_monthly_week_bucket.sql
-- Fixes the week bucket alignment in the monthly analytics breakdown for get_user_analytics.
-- Ensures that the week buckets start at the correct week start (Monday) for the month period.
