-- This migration fixes and refines the analytics breakdown logic.
-- 1. 'Today' view now correctly shows an hourly breakdown for the current calendar day (00:00-23:59).
-- 2. 'All Time' view now correctly generates a monthly series even if there are no events, preventing an empty chart.
