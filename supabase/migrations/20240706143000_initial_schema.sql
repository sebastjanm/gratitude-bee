...
--    This section ensures the script can be re-run without errors.
-- =================================================================
...
DROP TABLE IF EXISTS public.appreciation_templates CASCADE;
DROP TABLE IF EXISTS public.favor_templates CASCADE;
DROP TABLE IF EXISTS public.hornet_templates CASCADE;
...
ON public.appreciation_templates FOR SELECT USING (true);

CREATE POLICY "Admins can manage templates"
ON public.appreciation_templates FOR ALL
